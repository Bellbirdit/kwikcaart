                ...
                <div class="card-body">
                    <form id="store_form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    <label class="form-label">Store Name / Store Title<span
                                            class="text-danger">*</span></label>
                                    <input placeholder="Enter store name here" type="text" name="name" id="name"
                                        class="form-control" required />
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <label class="form-label">Code<span class="text-danger">*</span></label>
                                <input placeholder="e1234" type="text" name="code" id="code" class="form-control"
                                    required />
                            </div>
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input placeholder="56787" type="text" name="emirate" id="emirate"
                                    class="form-control" />
                            </div>
                            ...
                            <div class="col-lg-6">
                             ...
                             <div class="col-lg-6">
                                ...
                                <input type="text" name="timing" id="location" class="form-control" />
                            </div>
                            <div class="col-lg-6">
                        ...
                        <div class="col-12 mb-4 text-end mt-4">
                            <button type="submit" class="btn btn-md rounded font-sm hover-up" id="btnSubmit"><i
                                    class="fas fa-spinner fa-spin" style="display: none;"></i> Save Store</button>
                        </div>
                    </form>
                </div>
            </div>
