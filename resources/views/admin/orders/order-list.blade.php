...
?>
                    <div class="col-lg-2 col-md-12 col-sm-12 col-xs-12 ">
                        ...
                        <select class="form-control select2" id="filterStore" style="width: 100%;" tabindex="-1" aria-hidden="true">
                            <option value="code" selected>Select Store</option>
                            @foreach($storess as $store)
                            <option value="{{$store->code}}">{{strtoupper($store->name)}}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-lg-2 col-md-12 col-sm-12 col-xs-12 ">
                        <label>Status</label>
                        <select class="form-control select2" id="filterStatus" style="width: 100%;" tabindex="-1" aria-hidden="true">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-xs-12 mb-2">
                        <label><input type="checkBox" id="dateCheck" value="0" checked> Show All Dates Record</label>
                        <input type="hidden" id="dateCheck-input" value="0">
                        <input type="text" class="form-control" name="filterDate" id="filterDate" value="" disabled />
                        <input type="hidden" name="filterFromDate" id="filterFromDate" value="">
                        <input type="hidden" name="filterToDate" id="filterToDate">
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-2 mt-2">
                        <a class="btn btn-primary mt-3" href="javascript:;" id="btnFilter">Filter</a>
                        <a class="btn btn-danger text-start text-right mt-3" href="javascript:;" id="btnReset">Reset</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-hover" >
                    ...
                    <tfooter>
                        <tr id="divNotFound" style="display:none;justify-content:center" class="text-center justify-content-center">
                            <td colspan="7" class="text-center text-danger" style="justify-content:center"><b>No Data Found</b></td>
                        </tr>
                        <tr id="divLoader" class="text-center justify-content-center">
                            <td colspan="7" class="text-center "><i class="fas fa-spinner fa-spin"></i> Orders are bieng loading, please wait for a while</td>
                        </tr>
                    </tfooter>
                </table>
            </div>
        ...
        <div class="modal-content modal-content-demo">
            <form id="cancel_order" class="cancel_order">
                <div class="modal-header">
                    <h6 class="modal-title" style="color:#b12525;">Order Cancellation</h6><button aria-label="Close" class="btn-close" data-bs-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body">
                    <input type="hidden" name="id" id="order_id">
                    <input type="hidden" name="status" value="cancel">
                    <p style="color: #79515 !important;">Please provide breif details for cancelling the order</p>
