                    ...
                    <div class="row gx-5">
                        <aside class="col-lg-3 border-end">
                            <nav class="nav nav-pills flex-column mb-4 tab">
                                <a class="nav-link tablinks active clickTab" data-id="0" id="tablink0" aria-current="page"
                                    href="#">General</a>
                                <a class="nav-link tablinks clickTab" data-id="1" id="tablink1" href="#">Pricing</a>
                                <a class="nav-link tablinks clickTab" data-id="2" id="tablink2" id="tablink1" href="#">Images</a>
                                <a class="nav-link tablinks clickTab" data-id="3" id="tablink3" href="#">Variants</a>
                                <a class="nav-link tablinks clickTab" data-id="4" id="tablink4" href="#">Shipping & Delivery</a>
                                <a class="nav-link tablinks clickTab" data-id="5" id="tablink5" href="#">SEO keywords</a>
                                <a class="nav-link tablinks clickTab" data-id="6" id="tablink6" href="#">Frequently Bought Together</a>
                            </nav>
                        </aside>
                            ...
                            <form id="product_form">
                                ...
                                <section class="content-body p-xl-4">
                                    <div id="tab0" class="sec show">
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-lg-9">
                                                <input type="text" class="form-control" placeholder="Type here"
                                                    name="name" id="input_name" value="{{ $products->name }}" />
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                            <label class="col-lg-3 col-form-label">Barcode*</label>
                                            <div class="col-lg-9">
                                                <input type="text" class="form-control" placeholder="453544655"
                                                    name="barcode" id="input_barcode"
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-lg-9">
                                                <div class="custom_select ">
                                                    <select class="js-states form-control select2" name="category"
                                                        id="input_category" required>
                                        ...
                                        ?>
                                         <!--<div class="row mb-4">
                                            ...
                                            <div class="col-lg-9">
                                                <div class="custom_select ">
                                                    <select class="js-states form-control select2" name="store_id"
                                                        id="store_id" required>
                                                        <option value="" selected>Select Store</option>
                                                        @foreach($stores as $cod)
                                                            <option value="{{ $cod->code }}">
                                                                {{ ucwords($cod->code) }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-lg-9">
                                                <div class="custom_select ">
                                                    <select name="brand" id="input_brand"
                                                        class="js-states form-control select2">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-lg-9">
                                                <textarea class="form-control" name="short_description"
                                                    ...
                                                    id="input_short_description">{{ $products->short_description }}</textarea>
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-lg-9">
                                                <textarea class="form-control " placeholder="Type here"
                                                    name="description"
                                                    id="editor">{{ $products->description }}</textarea>
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-lg-9">
                                                <input type="number" class="form-control" name="warrenty"
                                                    placeholder="2 years" id="input_warranty"
                                                    value="{{ $products->warrenty }}" />
                                            </div>
                                            <!-- col.// -->
                                        </div>
                                        <div class="row mb-4">
                                        ...
                                        <br />
                                        <a href="javascript:;" class="btn btn-primary btnNext" data-id="0">Continue to
                                            next</a>
                                    </div>
                                    <div id="tab1" class="sec hide">
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="number" class="form-control" placeholder="price"
                                                    name="price" id="input_price" value="{{ $products->price }}" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-lg-5">
                                                <input type="number" class="form-control" placeholder="Offer price"
                                                    name="discount" id="input_discount_price"
                                                    value="{{ $products->discount }}" />
                                            </div>
                                            <div class=" col-lg-3">
                                                <div class="custom_select">
                                                    <select class=" form-control col-lg-5" name="discount_type"
                                                        id="input_discount_type">
                                                        <!-- <option value="falt" selected>Flat</option> -->
                                        ...
                                        <div class="row mb-4">
                                            <label class="col-lg-3 col-form-label">Minimum Order Quantity</label>
                                            <div class="col-lg-9">
                                                <input type="number" class="form-control" placeholder="1"
                                                    name="min_order_qty" id="input_min_order_qty"
                                                    value="{{ $products->min_order_qty }}" />
                                            </div>
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" class="form-control" placeholder="0.00"
                                                    name="unit_value" id="input_unit_value"
                                                    value="{{ $products->unit_value }}" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class=" col-lg-8">
                                                <div class="custom_select">
                                                    <select class=" form-control col-lg-5" name="featured"
                                                        id="input_featured">
                                        ...
                                        <a href="javascript:;" class="btn btn-primary btnNext" data-id="1">Continue to
                                            next</a>
                                    ...
                                    <div id="tab2" class="sec hide">
                                        <div class="card mb-4">
                                            ...
                                            <div class="card-body">
                                                <div class="input-upload">
                                                    ...
                                                    <img src="assets/imgs/theme/upload.svg" alt="" id="frame"
                                                        class="img-fluid" />
                                                    <label class="text-danger" id="error_thumbnail"
                                                        style="display: none;font-size:11px;font-weight:600;">Please
                                                        upload Product main image</label>
                                                    <input class="form-control" type="file" id="formFile"
                                                        onchange="preview()" name="thumbnail" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card mb-4">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" placeholder="Video Link"
                                                    name="video_link" id="input_video_link"
                                                    value="{{ $products->video_link }}" />
                                            </div>
                                            <div class=" col-lg-3">
                                                <div class="custom_select">
                                                    <select class=" form-control col-lg-5" name="video_provider"
                                                        id="input_video_provider">
                                        ...
                                        <a href="javascript:;" class="btn btn-primary btnNext" data-id="2">Continue to
                                            next</a>
                                    </div>
                                    <div id="tab3" class="sec hide">
                                        <div class="row mb-4">
                                            ...
                                            <div class="form-check col-lg-2">
                                                <input class="form-check-input input_size" type="checkbox" value="S"
                                                    id="product-cat" name="size[]" />
                                                <label class="form-check-label" for="product-cat"> S </label>
                                            </div>
                                            <div class="form-check col-lg-2">
                                                <input class="form-check-input input_size" type="checkbox"
                                                    value="M" id="product-cat-1" name="size[]" />
                                                <label class="form-check-label" for="product-cat-1"> M </label>
                                            </div>
                                            <div class="form-check col-lg-2">
                                                <input class="form-check-input input_size" type="checkbox" value="L"
                                                    id="product-cat-2" name="size[]" />
                                                <label class="form-check-label" for="product-cat-2"> L </label>
                                            </div>
                                            <div class="form-check col-lg-2">
                                                <input class="form-check-input input_size" type="checkbox" value="XL"
                                                    id="product-cat-2" name="size[]" />
                                                <label class="form-check-label" for="product-cat-2"> XL </label>
                                            </div>
                                            <div class="form-check col-lg-2">
                                                <input class="form-check-input input_size" type="checkbox" value="XXL"
                                                    id="product-cat-2" name="size[]" />
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="form-check col-lg-2">
                                                <input class="form-check-input input_colors" type="checkbox" value="Red"
                                                    id="product-cat" name="colors[]" />
                                                <label class="form-check-label" for="product-cat"> Red </label>
                                            </div>
                                            <div class="form-check col-lg-2">
                                                <input class="form-check-input input_colors" type="checkbox"
                                                    value="Blue" id="product-cat-1" name="colors[]" />
                                                <label class="form-check-label" for="product-cat-1"> Blue </label>
                                            </div>
                                            <div class="form-check col-lg-2">
                                                <input class="form-check-input input_colors" type="checkbox"
                                                    value="Green" id="product-cat-2" name="colors[]" />
                                                <label class="form-check-label" for="product-cat-2"> Green </label>
                                            </div>
                                            <div class="form-check col-lg-2">
                                                <input class="form-check-input input_colors" type="checkbox"
                                                    value="Yellow" id="product-cat-2" name="colors[]" />
                                                <label class="form-check-label" for="product-cat-2"> Yellow </label>
                                            </div>
                                            <div class="form-check col-lg-2">
                                                <input class="form-check-input input_colors" type="checkbox"
                                                    value="Orange" id="product-cat-2" name="colors[]" />
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="form-check col-lg-2">
                                                <input class="form-check-input input_weight" type="checkbox" value="50"
                                                    id="product-cat" name="weight[]" />
                                                <label class="form-check-label" for="product-cat"> 50Gm </label>
                                            </div>
                                            <div class="form-check col-lg-2">
                                                <input class="form-check-input input_weight" type="checkbox" value="100"
                                                    id="product-cat-1" name="weight[]" />
                                                <label class="form-check-label" for="product-cat-1">100Gm</label>
                                            </div>
                                            <div class="form-check col-lg-2">
                                                <input class="form-check-input input_weight" type="checkbox" value="150"
                                                    id="product-cat-2" name="weight[]" />
                                                <label class="form-check-label" for="product-cat-2">150Gm</label>
                                            </div>
                                            <div class="form-check col-lg-2">
                                                <input class="form-check-input input_weight" type="checkbox" value="500"
                                                    id="product-cat-2" name="weight[]" />
                                                <label class="form-check-label" for="product-cat-2"> 500Gm </label>
                                            </div>
                                            <div class="form-check col-lg-2">
                                                <input class="form-check-input input_weight" type="checkbox" value="1"
                                                    id="product-cat-2" name="weight[]" />
                                                <label class="form-check-label" for="product-cat-2"> 1Kg </label>
                                            </div>
                                        </div>
                                        ...
                                        <a href="javascript:;" class="btn btn-primary btnNext" data-id="3">Continue to
                                            next</a>
                                    </div>
                                    <div id="tab4" class="sec hide">
                                        <div class="row mb-4">
                                            ...
                                            <div class=" col-lg-8">
                                                <div class="custom_select">
                                                    <select class=" form-control col-lg-5" id="input_express_delivery"
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class=" col-lg-8">
                                                <div class="custom_select">
                                                    <select class=" form-control col-lg-5" id="input_cash_on_delivery"
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class=" col-lg-8">
                                                <div class="custom_select">
                                                    <select class=" form-control col-lg-5" id="input_refundable"
                                                        name="refundable">
                                        ...
                                        <!-- <div class="row mb-4">
                                            <label class="col-lg-8 col-form-label">Standerd Delivery Days</label>
                                            <div class=" col-lg-4">
                                                <input type="number" class="form-control" placeholder="2 Days" id="input_delivery_days" name="delivery_days" value="{{ $products->delivery_days }}" />
                                            </div>
                                        </div> -->
                                        <div class="card mb-4">
                                            <div class="card-header">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="mb-4">
                                                            ...
                                                            <input type="text" placeholder="inch" class="form-control" id="input_shipping_width" name="shipping_width" value="{{ $products->shipping_width }}" />
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="mb-4">
                                                            <label for="product_name" class="form-label">Height</label>
                                                            <input type="text" placeholder="inch" class="form-control" id="input_shipping_height" name="shipping_height" value="{{ $products->shipping_height }}" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="mb-4">
                                                    <label for="product_name" class="form-label">Weight</label>
                                                    <input type="text" placeholder="gam" class="form-control" id="input_shipping_weight" name="shipping_weight" value="{{ $products->shipping_weight }}" />
                                                </div>
                                                <div class="mb-4">
                                                    <label for="product_name" class="form-label">Shipping fees</label>
                                                    <input type="text" placeholder="AED" class="form-control" id="input_shipping_cost" name="shipping_cost" value="{{$products->shipping_cost}}" />
                                                </div>
                                        ...
                                        <a href="javascript:;" class="btn btn-primary btnNext" data-id="4">Continue to
                                            next</a>
                                    ...
                                    <div id="tab5" class="sec hide">
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-lg-9">
                                                <input type="text" class="form-control" placeholder="Type here"
                                                    id="input_meta_title" name="meta_title"
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-lg-9">
                                                <textarea class="form-control" placeholder="Type here" rows="4"
                                                    ...
                                                    name="meta_description">{{ $products->meta_description }}</textarea>
                                            </div>
                                            <!-- col.// -->
                                        </div>
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-lg-9">
                                                <input type="text" class="form-control w-100" id="input_meta_keywords"
                                                    name="meta_keywords" value="{{ $products->meta_keywords }}" />
                                            </div>
                                            <!-- col.// -->
                                        </div>
