...
<main class="container-fluid">
    ...
    <section class="content-main">
        ...
        <span>
            <i class="fas fa-spinner fa-spin"></i> {{__('Customers are being loading.. It might take few seconds')}}.
        </span>
    </div>
    <div class="row text-center " id="divNotFound" style="display:none">
        <h6 class="mt-lg-5" style="color:red;"><i class="bx bx-window-close"></i> {{__('No Customer Found')}} !</h6>
    </div>
    <div class="col-12">
        <div id="divPagination" class="mb-3">
