...
<section class="content-main">
    ...
    <section class="content-main">
        ...
        @foreach($cusorder as $custord)
        <?php 
            $details = App\Models\OrderItem::where('order_id',$custord->id)->get(); 
            $proplusprice =  App\Models\OrderItem::where(['order_id'=>$custord->id])->pluck('products_quantityprice')->sum();
            ...
            <header class="card-header">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-6 mb-lg-0 mb-15">
                        <span> <i class="material-icons md-calendar_today"></i> <b>{{$custord->created_at}}</b> </span>
                        <br />
                        <small class="text-muted">Order ID: {{ $custord->order_number }}</small>
                    </div>
                </div>
            </header>
            <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <a class="itemside" href="javascript:;">
                                                <div class="left">
                                    ...
                                    <tr>
                                        <td colspan="4">
                                            <article class="float-end">
                                                ...
                                                <dl class="dlist">
                                                    <dt>Shipping cost:</dt>
                                                    <dd>{{$custord->deliverycharges}}</dd>
                                                </dl>
                                                  <dl class="dlist">
                                                  <dt>Coupon Discount:</dt>
                                                    <dd>{{$custord->coupondiscount}}</dd>
                                                </dl>
                                                <dl class="dlist">
                                                    <dt>Grand total:</dt>
                                                    <dd><b class="h5">{{round($custord->coupon_payment,2)}}</b></dd>
                                                </dl>
                                                <dl class="dlist">
                                                    <dt class="text-muted">Status:</dt>
                                                    <dd>
                                                        <span class="">{{$custord->order_status}}</span>
                                                    </dd>
                                                </dl>
                                            </article>
                                        </td>
                    ...
                    <div class="col-lg-4">
                        <div class="h-25 pt-4">
                            <div class="text">
                                ...
                                <p class="mb-1">
                                    Shipping: {{ $custord->delivery_option }} <br />
                                    Pay method: {{$detail->payment_getway}} <br />
                                    Status: {{ $custord->order_status }}
                                </p>
                            </div>
                            <div class="text">
