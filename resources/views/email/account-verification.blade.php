...
<body>
    <div class="main">
        <div class="rozgar">
            ...
            <div class="text">
                <h1 id="text">HI,   {{ucwords($user->name)}}</h1>
                <p>Here is the confirmation code for your account verfication</p>
                <span id="code">{{$otp}}</span>
                <p class="p">All you have to do is copy the confirmation code and paste it to your form to complete the
                    verfication process</p>
