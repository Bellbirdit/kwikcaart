...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  mt-2 mb-1">
        <a class="btn btn-primary" href="/user/ticket/list">
...
<div class="row corner1">
    <div class="row ml-34" id="corner" style="width: 94%; margin-top:15px;">
        ...
        <div class="col-lg-12">
            <div class="card1 mt-2 bg-white" style="box-shadow:none; border: 1px solid #e9ebec; margin-left:0px;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group input-group-merge">
                                            <textarea class="form-control mt-2" name="message" id="" cols="30" rows="5"
                                                required></textarea>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-9 offset-sm-3">
                                <button type="submit" id="Addticket" class="btn btn-primary me-1 .btn-relief-{color} mt-2"><i
